...
PathFinder AI is a full-stack campus placement management system that uses a **hybrid AI pipeline** to match students with job drives fairly, transparently, and without relying on any external API.
...
This project is a personal campus placement management system designed to streamline student-job matching, recruiter shortlisting, and administrative oversight.
...
POST /shortlist/approve                 # Approve a candidate
